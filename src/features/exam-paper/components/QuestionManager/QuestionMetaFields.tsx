    ...
    <>
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
        <div className="flex-1 space-y-1.5">
          ...
          <select value={editQuestion.correct_answer} onChange={(e) => update('correct_answer', e.target.value)} className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm outline-none">
        ...
        <div className="flex-1 space-y-1.5">
          ...
          <select value={editQuestion.column} onChange={(e) => update('column', e.target.value as any)} className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm outline-none">
      ...
      <div className="space-y-1.5">
        ...
        <textarea value={editQuestion.explanation || ''} onChange={(e) => update('explanation', e.target.value)} className="w-full bg-slate-900 border border-slate-700 rounded-xl p-3 text-sm focus:ring-1 focus:ring-blue-500 outline-none min-h-[60px]" />
      </div>
    </>
  );
};
